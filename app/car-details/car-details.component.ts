...
export class CarDetailsComponent implements OnInit {
  ...
  constructor(private BrandsService:BrandsService,private BodyShapes:BodyShapesService ,
   private userCars :UserCarsService,private fileService:FileService)
     {
      //this.brands=this.BrandsService.getBrands();
      //this.models=this.Brands.getBrandModels(brandname)
  ...
  brandSelected(brand:ICarBrand)
  {
    ...
    //this.models=this.BrandsService.getBrandModels(brandName);
    this.Car.modelName="";
    this.Car.year=0;
